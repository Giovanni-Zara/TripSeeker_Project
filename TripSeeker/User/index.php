...
<html lang="en">
<?php 
    //va messo sennò anche senza essere loggato potresti raggiungere questa pagina
    session_start();
...
<body class="text-center">
            ...
            <div id="second_col" >
                ...
                <div id="second_row" style= " background-color: #ffffff00; padding:10px; text-align: left;">
                    ...
                    <div id="guarda_interessi" style="display:block; justify-contente:center;" >
                        <!--form per permettere di eliminare tutti gli interessi selezionati-->
                        ...
                        <!--  in base alle informazioni/interessi selezionati dall'utente li mostri in div sottostante-->
                        <?php   
                           $dbconn = pg_connect("host=localhost port=5432 dbname=ltw user=postgres password=biar");
                           $email = $_SESSION["email"];
                           ...
                           if ($num_rows > 1) {
                            ...
                            echo '<script>';
                            echo 'var numInteressi = ' . $num_interessi . ';'; // Stampa il valore della variabile come parte del codice JavaScript, usata per regolare la progressbar
                            echo '</script>';
                        ?>
                    </div>
                    <style>
                           ...
                           <h4>Viaggi</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <script>
                                        //funzione JQUERY per selezionare un solo elemento di un gruppo di checkbox
                ...
                <div id="last_row">
                    ...
                    <div id="colonna_recensioni">
                        <!--div contenente tutte le recensioni ricevute-->
                            <?php
    ...
    <script>//funzione per aggiornare la barra di avanzamento
