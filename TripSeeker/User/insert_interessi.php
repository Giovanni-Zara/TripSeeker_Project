...
<?php
    ...
    //nel codice sottostante si fa un controllo per vedere se i campi sono stati settati o meno, se sono stati settati allora si inseriscono nel db come stringhe separate da virgole, altrimenti si inserisce una stringa vuota
    ...
    if(!$result){
        ...
        if($row == 0){
           ...
           // non tutti i campi sono obbligatori non puoi sapere a prescindere il numero di parametri che userai in query dinamica 
