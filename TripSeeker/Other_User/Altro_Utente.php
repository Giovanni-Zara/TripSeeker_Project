    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid" id="griglia1x3">
            ...
            <div id="second_col" >
                    ...
                    <?php       //parte per far apparire le stelle delle recensioni utente
                ...
                <div class="row" id="first_row">
                    ...
                    <!--parte a destra della foto profilo con nome cognome e username messi nella registrazione-->
                ...
                <div id="second_row" style= "background-color: #ffffff00;  padding:10px; text-align: left;">
                    ...
                    <?php       //mostra gli ultimi due viaggii effettuati dall'utente
                        $EMAIL = $email_utente;//ottenuta con get
                        $dbconn= pg_connect("host=localhost port=5432 dbname=ltw user=postgres password=biar");
                ...
                <br>
                <script>
                //funzione jquery per mostrare in maniera asincrona la recensione appena inserita, oppure il messaggio che utente gia recensito
