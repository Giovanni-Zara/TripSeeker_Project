...
/**
Il codice JavaScript utilizza la libreria jQuery e la tecnologia AJAX per inviare i dati del form al server senza ricaricare la pagina. 
In particolare, quando l'utente preme il pulsante di invio del form, il codice jQuery intercetta l'evento di submit e invia i dati tramite il metodo $.ajax(). 
In questo modo, il server PHP riceve i dati, li elabora e restituisce il risultato, che viene gestito dalla funzione success() o error() di jQuery.
 */