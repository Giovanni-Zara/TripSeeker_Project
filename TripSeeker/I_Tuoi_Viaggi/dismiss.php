...
<body>
    <?php 
        ...
        if(pg_num_rows($result) > 0){//se trovi già la tupla vuol dire che utente è già partecipante a questo viaggio
            //se email corrispodne a email creatore cancelli il viaggio a tutti gli utenti che partecipano
