...
<body class="text-center">
    ...
    <nav id="barra_nav"   class="navbar navbar-expand-lg navbar-light bg-info">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="btn-group d-flex flex-wrap justify-content-center" role="group" aria-label="Button group" style="margin-bottom: 20px;">
                        <!--bottone che se premi ricarica la pagina e quindi resetta i filtri-->
        ...
        <div class="container-fluid" id="griglia1x3">
            ...
            <div id="second_col" >
                <?php
                    //funzione chiamata per far apparire la foto profilo dei partecipanti al viaggio
                    ...
                    //funzione che serve per far apparire i viaggi, ordinati secondo quanto richiesto, in base a cosa si è inserito nella barra di ricerca piccola, si cerca sia dentro al descrizione del viaggio che nella destinazione
                    ...
                    //funzione chiamata per ordinamento dei viaggi
                    ...
                    //funzione che crea il div per un annuncio di un viaggio
